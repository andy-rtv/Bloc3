...
namespace BLOC3.Migrations
{
    ...
    [Migration("20240527185916_SeedDataMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BLOC3.Areas.Identity.Data.JO2024User", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.Achat", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.AchatEvenementOffre", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.Evenement", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.Offre", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.Ticket", b =>
                {
            ...
            modelBuilder.Entity("BLOC3.Models.Achat", b =>
                {
                    b.HasOne("BLOC3.Areas.Identity.Data.JO2024User", "Utilisateur")
                        .WithMany("Achats")
            ...
            modelBuilder.Entity("BLOC3.Models.AchatEvenementOffre", b =>
                {
                    b.HasOne("BLOC3.Models.Achat", "Achat")
                        .WithMany("AchatEvenementOffres")
                        .HasForeignKey("AchatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BLOC3.Models.Evenement", "Evenement")
                        .WithMany("AchatEvenementOffres")
                        .HasForeignKey("EvenementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BLOC3.Models.Offre", "Offre")
                        .WithMany("AchatEvenementOffres")
            ...
            modelBuilder.Entity("BLOC3.Models.Ticket", b =>
                {
                    b.HasOne("BLOC3.Models.Evenement", null)
                        .WithMany("Tickets")
                        .HasForeignKey("EvenementId_Evenement");

                    b.HasOne("BLOC3.Models.AchatEvenementOffre", "AchatEvenementOffre")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BLOC3.Areas.Identity.Data.JO2024User", null)
                        .WithMany()
